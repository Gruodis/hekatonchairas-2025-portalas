...
export default function AgendaList({ items }: AgendaListProps): JSX.Element {
  return (
    <section className="flex flex-col items-center justify-center">
      <h1>Programa</h1>
      <div className="max-w-[900px] bg-green-100/5 w-full divide-y-2 divide-white/20 border-2 border-white/10 rounded-3xl shadow-[inset_0_0px_120px_0px_theme(colors.primary-dark/0.1),0_0px_120px_0px_theme(colors.secondary-dark/0.1)]">
